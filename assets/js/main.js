    ...
    const knowledgeBase = [
      {
        ...
        response: "Nos missions démarrent à 4 500 € pour un prototype complet (tests et transfert inclus)." 
      },
      {
        keywords: ['agent builder', 'builder', 'openai', 'agent'],
        response: "Nous préparons la structure Agent Builder : rôle, accès, jeux de test et planning des déclencheurs."
      },
      {
        keywords: ['crm', 'salesforce', 'hubspot'],
        response: "Nous synchronisons votre CRM : création de fiches, champs obligatoires et notifications ciblées."
      },
      {
        keywords: ['erp', 'stock', 'logistique', 'supply'],
        response: "Nous orchestrons la mise à jour ERP, les contrôles de stock et les alertes logistiques avec <span class=\"term\" data-key=\"journalisation\">suivi écrit</span>."
      },
      {
        keywords: ['support', 'service client', 'sav'],
        response: "Nous automatisons la qualification SAV, la création de tickets et l’escalade avec validations humaines aux étapes clés."
      }
    ];

    const defaultResponses = [
      "Merci. Nous préparons une fiche processus et un prototype test sous 48 h.",
      "Compris. Je vous envoie notre gabarit de diagnostic pour noter les entrées/sorties.",
